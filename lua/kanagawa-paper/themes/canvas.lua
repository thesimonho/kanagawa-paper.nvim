...
M.get = function(opts, palette)
	return {
		...
		diag = {
			...
			info = palette.canvasBlue2,
			info_light = color(palette.canvasBlue2):blend(palette.canvasWhite4, 0.9):to_hex(),
