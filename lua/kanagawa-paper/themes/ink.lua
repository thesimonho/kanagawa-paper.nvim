...
M.get = function(opts, palette)
	...
	return {
		...
		diag = {
			...
			ok_light = color(palette.dragonGreen):blend(palette.sumiInk3, 0.97):to_hex(),
			error = palette.dragonRed,
			error_light = color(palette.dragonRed):blend(palette.sumiInk3, 0.97):to_hex(),
			warning = palette.dragonYellow,
			warning_light = color(palette.dragonYellow):blend(palette.sumiInk3, 0.97):to_hex(),
			info = palette.dragonBlue,
			info_light = color(palette.dragonBlue):blend(palette.sumiInk3, 0.97):to_hex(),
			hint = palette.dragonAqua,
			hint_light = color(palette.dragonAqua):blend(palette.sumiInk3, 0.97):to_hex(),
		},
		term = {
